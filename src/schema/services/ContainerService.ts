...
import type { FilesystemChange } from '../models/FilesystemChange';
...
export class ContainerService {
     ...
     *
     * @param platform Platform in the format `os[/arch[/variant]]` used for image lookup.
     *
    ...
    public static containerChanges(
        id: string,
    ): CancelablePromise<Array<FilesystemChange>> {
        return __request(OpenAPI, {
            method: 'GET',
